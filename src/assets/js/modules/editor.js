...
// import { showToast } from '/src/assets/js/ui.js'; // Assuming this exists or we use fallback
...
export async function init(root) {
                ...
                <div id="pageSpecificSection" style="display:none;" class="mb-4">
                    <div class="row g-3 bg-white p-3 rounded border shadow-sm">
                        ...
                        <div class="col-md-6" id="pathContainer" style="display:none;">
                            ...
                            <input type="text" class="form-control form-control-sm" id="pathInput" placeholder="src/route/posts/my-post.md">
                        </div>
                    </div>
                </div>
    ...
    async function loadEntity() {
        ...
        if (collectionType === 'page' && mode === 'database') {
            ...
            const found = IncludeParser.getLocalPosts().find(p => p.path === postPath || p.id === entityId);
            if (found) {
